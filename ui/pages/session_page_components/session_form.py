...
class SessionForm(ctk.CTkScrollableFrame):
    ...
    """
    def __init__(self, parent, generate_callback, open_preview_callback, toggle_form_callback):
        ...
        ctk.CTkLabel(formats_frame, text="Formats").grid(row=0, column=0, sticky="w", pady=(0,4))
        ...
        ctk.CTkButton(btns, text="Générer", command=generate_callback)\
            .grid(row=0, column=0, sticky="ew", padx=4, pady=4)
        ctk.CTkButton(btns, text="Regénérer tout", command=generate_callback)\
            .grid(row=0, column=1, sticky="ew", padx=4, pady=4)
        ctk.CTkButton(btns, text="Agrandir l’aperçu", command=open_preview_callback)\
            .grid(row=1, column=0, sticky="ew", padx=4, pady=4)
        ctk.CTkButton(btns, text="Masquer le formulaire", command=toggle_form_callback)\
