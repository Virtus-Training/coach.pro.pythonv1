...
def create_pill(parent, text, fg_color="#0a6b84"):
    ...
    ctk.CTkLabel(f, text=text, padx=10, pady=2, font=("Segoe UI", 11, "bold"), text_color="#fff").pack()
    return f
...
def create_icon_label(parent, icon_path, text):
    ...
    try:
        ...
        ctk.CTkFrame(row, width=18, fg_color="transparent").pack(side="left", padx=(0,6))
