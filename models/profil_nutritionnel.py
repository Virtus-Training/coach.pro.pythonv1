...
class ProfilNutritionnel:
    ...
    def calculer_repartition_macros(self) -> Dict[str, float]:
        ...
        repartitions = {
            ObjectifNutritif.PERTE_POIDS.value: {
                "proteines": 0.30,
                "glucides": 0.35,
                "lipides": 0.35,
            },
            ObjectifNutritif.PRISE_MUSCLE.value: {
                "proteines": 0.25,
                "glucides": 0.45,
                "lipides": 0.30,
            },
            ObjectifNutritif.MAINTENANCE.value: {
                "proteines": 0.20,
                "glucides": 0.50,
                "lipides": 0.30,
            },
            ObjectifNutritif.PERFORMANCE.value: {
                "proteines": 0.20,
                "glucides": 0.55,
                "lipides": 0.25,
            },
            ObjectifNutritif.SANTE_GENERALE.value: {
                "proteines": 0.20,
                "glucides": 0.50,
                "lipides": 0.30,
            },
        ...
        repartition = repartitions.get(
            self.objectif_principal, repartitions[ObjectifNutritif.MAINTENANCE.value]
        )
...
class ObjectifMacro:
    ...
    def __post_init__(self):
        if self.kcal_total == 0.0:
            self.kcal_total = (
                (self.proteines_g * 4) + (self.glucides_g * 4) + (self.lipides_g * 9)
            )
