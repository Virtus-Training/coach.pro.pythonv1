...
class WorkoutGenerationConfig:
    ...
    muscle_balance_rules: Dict[str, float] = field(
    ...
    format_rules: Dict[str, Dict[str, Any]] = field(
        default_factory=lambda: {
            "AMRAP": {
    ...
    favorite_exercises: Dict[str, List[str]] = field(
        default_factory=lambda: {
    ...
    exercise_restrictions: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    equipment_management: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    # Gestion temporelle
    timing_rules: Dict[str, Any] = field(
        default_factory=lambda: {
    ...
    physiological_rules: Dict[str, Any] = field(
        default_factory=lambda: {
            "fatigue_management": {
    ...
    def update_learning_from_session(
        self, session_data: Dict[str, Any], feedback_score: float
    ):
    ...
    def get_smart_recommendations(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        context.get("course_type", "Cross-Training")
        ...
        if format_type in self.format_rules:
            ...
            recommendations["preferred_patterns"] = format_rule.get(
                "prefer_patterns", []
            )
            ...
            for key, combos in successful_combos.items():
                if key.startswith(format_type):
                    sorted_combos = sorted(
                        combos, key=lambda x: x["score"], reverse=True
                    )
