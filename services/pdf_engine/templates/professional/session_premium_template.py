...
class SessionPremiumTemplate(BaseTemplate):
    ...
    def _build_premium_header(self) -> Table:
        ...
        header_data = [
            ...
            [
                Paragraph(
                    "EXCELLENCE • PERSONNALISATION • PERFORMANCE",
                    ParagraphStyle(
                        "Tagline",
            ...
            [
                Paragraph(
                    f"<b>Client:</b> {client_name}<br/><b>Coach:</b> {coach_name}",
                    ParagraphStyle(
                        "ClientInfo",
                ...
                Paragraph(
                    f"<b>Date:</b> {session_date}<br/><b>Heure:</b> {session_time}",
                    ParagraphStyle(
                        "SessionInfo",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
    ...
    def _build_client_profile(self) -> Table:
        ...
        profile_data = [
            [
                Paragraph(
                    "<b>PROFIL CLIENT - PERSONNALISATION PREMIUM</b>",
                    ParagraphStyle(
                        "ProfileTitle",
            ...
            [
                Paragraph(
                    f"<b>Niveau:</b> {profile.get('fitness_level', 'Non défini')}",
                    ParagraphStyle(
                        "ProfileItem",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
            ...
            [
                Paragraph(
                    f"<b>Préférences:</b> {', '.join(profile.get('preferences', []))}",
                    ParagraphStyle(
                        "ProfileItem",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
            ...
            [
                Paragraph(
                    f"<b>Limitations:</b> {', '.join(profile.get('limitations', []))}",
                    ParagraphStyle(
                        "ProfileItem",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
            ...
            [
                Paragraph(
                    f"<b>Expérience:</b> {profile.get('experience', 'Non définie')}",
                    ParagraphStyle(
                        "ProfileItem",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
    ...
    def _build_session_goals(self) -> Table:
        ...
        goals_data = [
            [
                Paragraph(
                    "<b>OBJECTIFS DE SÉANCE - EXCELLENCE CIBLÉE</b>",
                    ParagraphStyle(
                        "GoalsTitle",
                        fontSize=self.fonts["heading"][1],
                        textColor=colors.white,
    ...
    def _build_exercise_program(self) -> List[Flowable]:
        ...
        content.append(
            Paragraph(
                "<b>PROGRAMME D'ENTRAÎNEMENT - CONCEPTION PREMIUM</b>",
                ParagraphStyle(
                    "ProgramTitle",
                    fontSize=self.fonts["heading"][1],
        ...
        for i, exercise in enumerate(exercises):
            ...
            exercise_data = [
                [
                    ...
                    Paragraph(
                        f"<b>{duration}</b><br/><i>{intensity}</i>",
                        ParagraphStyle(
                            "ExerciseSpecs",
                            fontSize=self.fonts["body"][1],
                            textColor=colors.white,
    ...
    def _build_coach_notes_section(self) -> Table:
        ...
        notes_data = [
            [
                Paragraph(
                    "<b>NOTES PROFESSIONNELLES DU COACH</b>",
                    ParagraphStyle(
                        "NotesTitle",
                        fontSize=self.fonts["heading"][1],
                        textColor=colors.white,
        ...
        if pre_session:
            notes_data.append(
                [
                    Paragraph(
                        f"<b>🎯 Pré-Séance:</b><br/>{pre_session}",
                        ParagraphStyle(
                            "PreSession",
                            fontSize=self.fonts["body"][1],
                            textColor=self.colors["text"],
        ...
        if during_session:
            notes_data.append(
                [
                    Paragraph(
                        f"<b>⚡ Pendant la Séance:</b><br/>{during_session}",
                        ParagraphStyle(
                            "DuringSession",
                            fontSize=self.fonts["body"][1],
                            textColor=self.colors["text"],
        ...
        if post_session:
            notes_data.append(
                [
                    Paragraph(
                        f"<b>📝 Post-Séance:</b><br/>{post_session}",
                        ParagraphStyle(
                            "PostSession",
                            fontSize=self.fonts["body"][1],
                            textColor=self.colors["text"],
        ...
        if next_session:
            notes_data.append(
                [
                    Paragraph(
                        f"<b>🎪 Prochaine Séance:</b><br/>{next_session}",
                        ParagraphStyle(
                            "NextSession",
                            fontSize=self.fonts["body"][1],
                            textColor=self.colors["luxury"],
    ...
    def _build_adaptations_section(self) -> Table:
        ...
        adaptations_data = [
            [
                Paragraph(
                    "<b>ADAPTATIONS TEMPS RÉEL - COACHING RÉACTIF</b>",
                    ParagraphStyle(
                        "AdaptationsTitle",
                        fontSize=self.fonts["heading"][1],
                        textColor=colors.white,
        ...
        adaptations_table = Table(
            adaptations_data, colWidths=[2 * cm, 5 * cm, 5 * cm, 6 * cm]
        )
        adaptations_table.setStyle(
            TableStyle(
                [
    ...
    def _build_premium_summary(self) -> Table:
        ...
        client_feedback = self.data.get(
            "client_feedback", "Séance parfaitement adaptée à mes besoins"
        )
        ...
        summary_data = [
            ...
            [
                Paragraph(
                    f"<b>Évaluation Globale:</b> {session_rating}",
                    ParagraphStyle(
                        "Rating",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["luxury"],
            ...
            [
                Paragraph(
                    f'<b>Retour Client:</b><br/><i>"{client_feedback}"</i>',
                    ParagraphStyle(
                        "Feedback",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
            ...
            [
                Paragraph(
                    f"<b>Prochain RDV:</b> {next_appointment}",
                    ParagraphStyle(
                        "NextAppt",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
            ...
            [
                Paragraph(
                    "Signature Coach: ___________________",
                    ParagraphStyle(
                        "CoachSignature",
