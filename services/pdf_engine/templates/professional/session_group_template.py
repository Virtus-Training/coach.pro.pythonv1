...
class SessionGroupTemplate(BaseTemplate):
    ...
    def _validate_group_data(self) -> None:
        ...
        required_fields = [
            "title", "instructor_name", "session_date", "group_size",
            "exercises", "playlist", "team_goals"
        ]
        ...
        defaults = {
            ...
            "exercises": [
                ...
                },
                {
                    ...
                    "variations": {
                        "tous": "Étirements synchronisés"
                    },
                    "motivation": "Célébration des efforts"
                }
            ],
            "playlist": [
                {"song": "Warm Up Energy", "artist": "Motivation Mix", "bpm": "120", "phase": "Échauffement"},
                {"song": "Beast Mode", "artist": "Workout Heroes", "bpm": "140", "phase": "Circuit"},
                {"song": "Team Power", "artist": "Group Energy", "bpm": "145", "phase": "Défi"},
                {"song": "Cool Victory", "artist": "Relaxation", "bpm": "90", "phase": "Récupération"}
            ],
            "team_goals": [
    ...
    def _build_group_header(self) -> Table:
        ...
        header_data = [
            ...
            [
                Paragraph("⚡ ÉNERGIE • ÉQUIPE • EXCELLENCE ⚡", ParagraphStyle(
                    'Motto',
            ...
            [
                Paragraph(f"<b>👨‍🏫 Instructeur:</b> {instructor}<br/><b>👥 Groupe:</b> {group_size}", ParagraphStyle(
                    'InstructorInfo',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT
                )),
                Paragraph(f"<b>📅 Date:</b> {session_date}<br/><b>⏰ Heure:</b> {session_time}<br/><b>📍 Lieu:</b> {location}", ParagraphStyle(
                    'SessionDetails',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["text"],
                    alignment=TA_RIGHT
    ...
    def _build_team_composition(self) -> Table:
        ...
        team_data = self.data.get("team_composition", {
            "beginners": 4,
            "intermediate": 6,
            "advanced": 2,
            "total": 12
        ...
        composition_data = [
            [
                Paragraph("<b>🎯 COMPOSITION ÉQUIPE</b>", ParagraphStyle(
                    'TeamTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
                )),
                Paragraph("<b>⚡ NIVEAU D'ÉNERGIE CIBLE</b>", ParagraphStyle(
                    'EnergyTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
            ...
            [
                Paragraph(f"🟢 <b>Débutants:</b> {team_data.get('beginners', 0)}<br/>"
                         f"🟡 <b>Intermédiaires:</b> {team_data.get('intermediate', 0)}<br/>"
                         f"🔴 <b>Avancés:</b> {team_data.get('advanced', 0)}<br/>"
                         f"👥 <b>Total:</b> {team_data.get('total', 0)}", ParagraphStyle(
                    'TeamBreakdown',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT,
                ...
                Paragraph(f"<b>{energy_level}</b><br/><br/>🎵 Musique énergisante<br/>🏆 Défis collectifs<br/>🤝 Entraide obligatoire", ParagraphStyle(
                    'EnergyDescription',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["energy"],
                    alignment=TA_CENTER
    ...
    def _build_team_goals(self) -> Table:
        ...
        goals_data = [
            [
                Paragraph("<b>🎯 OBJECTIFS COLLECTIFS - ENSEMBLE VERS LA VICTOIRE</b>", ParagraphStyle(
                    'TeamGoalsTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
        ...
        for i, goal in enumerate(team_goals):
            ...
            goals_data.append([
                Paragraph(f"{icon} {goal}", ParagraphStyle(
                    'TeamGoal',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT,
    ...
    def _build_group_exercises(self) -> List[Flowable]:
        ...
        # Exercises header
        content.append(
            Paragraph("<b>💪 PROGRAMME COLLECTIF - ADAPTATION POUR TOUS 💪</b>", ParagraphStyle(
                'ExercisesTitle',
                fontSize=self.fonts["heading"][1],
                textColor=self.colors["primary"],
                alignment=TA_CENTER,
        ...
        for i, exercise in enumerate(exercises):
            ...
            exercise_data = [
                [
                    ...
                    Paragraph(f"<b>⏱️ {duration}</b><br/>⚡ {energy_level}", ParagraphStyle(
                        'ExerciseSpecs',
                        fontSize=self.fonts["body"][1],
                        textColor=colors.white,
                        alignment=TA_CENTER
                ...
                [
                    Paragraph(f"<b>🤝 Élément d'équipe:</b> {team_element}", ParagraphStyle(
                        'TeamElement',
                        fontSize=self.fonts["body"][1],
                ...
                [
                    Paragraph(f"<b>🎯 Motivation:</b> <i>{motivation}</i>", ParagraphStyle(
                        'Motivation',
                        fontSize=self.fonts["body"][1],
            ...
            if variations:
                ...
                level_colors = {"débutant": "🟢", "intermédiaire": "🟡", "avancé": "🔴", "tous": "🟦"}

                for level, variation in variations.items():
                    icon = level_colors.get(level, "•")
                    variations_text += f"{icon} <b>{level.title()}:</b> {variation}<br/>"

                exercise_data.append([
                    Paragraph(variations_text, ParagraphStyle(
                        'Variations',
            ...
            header_color = [self.colors["primary"], self.colors["secondary"], self.colors["accent"], self.colors["energy"]][i % 4]
            ...
            exercise_table.setStyle(TableStyle([
                ...
                ('SPAN', (0, 1), (1, 1)),
                ('SPAN', (0, 2), (1, 2)),
                ('SPAN', (0, 3), (1, 3)) if len(exercise_data) > 3 else ('SPAN', (0, 2), (1, 2)),
    ...
    def _build_playlist_section(self) -> Table:
        ...
        playlist_data = [
            [
                Paragraph("<b>🎵 PLAYLIST ÉNERGIQUE - MUSIQUE = MOTIVATION</b>", ParagraphStyle(
                    'PlaylistTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
            ...
            [
                Paragraph("<b>Titre</b>", ParagraphStyle(
                    'PlaylistHeader',
                    fontSize=self.fonts["emphasis"][1],
                    textColor=self.colors["primary"],
                    alignment=TA_LEFT
                )),
                Paragraph("<b>Artiste</b>", ParagraphStyle(
                    'PlaylistHeader',
                    fontSize=self.fonts["emphasis"][1],
                    textColor=self.colors["primary"],
                    alignment=TA_LEFT
                )),
                Paragraph("<b>BPM</b>", ParagraphStyle(
                    'PlaylistHeader',
                    fontSize=self.fonts["emphasis"][1],
                    textColor=self.colors["primary"],
                    alignment=TA_CENTER
        ...
        for song in playlist:
            ...
            playlist_data.append([
                Paragraph(f"🎵 {song_title}", ParagraphStyle(
                    'SongTitle',
                    fontSize=self.fonts["caption"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT
                )),
                Paragraph(artist, ParagraphStyle(
                    'Artist',
                    fontSize=self.fonts["caption"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT
                )),
                Paragraph(f"<b>{bpm}</b>", ParagraphStyle(
                    'BPM',
                    fontSize=self.fonts["caption"][1],
                    textColor=self.colors["energy"],
                    alignment=TA_CENTER
        ...
        playlist_table = Table(playlist_data, colWidths=[6*cm, 5*cm, 3*cm, 4*cm])
    ...
    def _build_team_challenges(self) -> Table:
        ...
        challenges = self.data.get("team_challenges", [
            {"challenge": "Synchronisation parfaite", "points": "50", "difficulty": "🟡"},
            {"challenge": "Encouragements continus", "points": "30", "difficulty": "🟢"},
            {"challenge": "Dépassement collectif", "points": "100", "difficulty": "🔴"},
            {"challenge": "Esprit d'équipe", "points": "40", "difficulty": "🟢"}
        ])

        challenges_data = [
            [
                Paragraph("<b>🏆 DÉFIS ÉQUIPE - POINTS DE MOTIVATION 🏆</b>", ParagraphStyle(
                    'ChallengesTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
            ...
            [
                Paragraph("<b>Défi</b>", ParagraphStyle(
                    'ChallengeHeader',
                    fontSize=self.fonts["emphasis"][1],
                    textColor=self.colors["team"],
                    alignment=TA_LEFT
                )),
                Paragraph("<b>Points</b>", ParagraphStyle(
                    'ChallengeHeader',
                    fontSize=self.fonts["emphasis"][1],
                    textColor=self.colors["team"],
                    alignment=TA_CENTER
                )),
                Paragraph("<b>Difficulté</b>", ParagraphStyle(
                    'ChallengeHeader',
                    fontSize=self.fonts["emphasis"][1],
                    textColor=self.colors["team"],
                    alignment=TA_CENTER
        ...
        for challenge in challenges:
            ...
            challenges_data.append([
                Paragraph(f"🎯 {challenge_name}", ParagraphStyle(
                    'Challenge',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT
                )),
                Paragraph(f"<b>{points}</b>", ParagraphStyle(
                    'Points',
                    fontSize=self.fonts["emphasis"][1],
                    textColor=self.colors["energy"],
                    alignment=TA_CENTER
    ...
    def _build_energy_summary(self) -> Table:
        ...
        group_feedback = self.data.get("group_feedback", "Énergie incroyable ! On recommence quand ?")
        next_session = self.data.get("next_group_session", "Même jour, semaine prochaine")

        summary_data = [
            [
                Paragraph("<b>⚡ BILAN ÉNERGÉTIQUE DU GROUPE ⚡</b>", ParagraphStyle(
                    'SummaryTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
            ...
            [
                Paragraph(f"<b>🔥 Énergie Totale Atteinte:</b> {total_energy}", ParagraphStyle(
                    'EnergyTotal',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["energy"],
                    alignment=TA_LEFT,
            ...
            [
                Paragraph(f"<b>🤝 Esprit d'équipe:</b> {team_spirit}", ParagraphStyle(
                    'TeamSpirit',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["team"],
                    alignment=TA_LEFT,
            ...
            [
                Paragraph(f"<b>💬 Retour du groupe:</b><br/><i>\"{group_feedback}\"</i>", ParagraphStyle(
                    'GroupFeedback',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT,
            ...
            [
                Paragraph(f"<b>🗓️ Prochaine séance collective:</b> {next_session}", ParagraphStyle(
                    'NextSession',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["motivation"],
                    alignment=TA_LEFT,
            ...
            [
                Paragraph("🏆 <b>BRAVO À TOUTE L'ÉQUIPE !</b> 🏆", ParagraphStyle(
                    'Celebration',
