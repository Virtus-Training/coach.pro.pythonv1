...
class NutritionSheetEducationTemplate(BaseTemplate):
    ...
    def _validate_education_data(self) -> None:
        ...
        required_fields = [
            "title", "topic", "learning_objectives",
            "key_concepts", "practical_tips"
        ]
    ...
    def _build_education_header(self) -> Table:
        ...
        header_data = [
            [
                ...
                Paragraph(f"<b>📚 FORMATION</b>", ParagraphStyle(
                    'Badge',
                    fontSize=12,
            ...
            [
                Paragraph(f"<i>{topic}</i>", ParagraphStyle(
                    'Subtitle',
                    fontSize=self.fonts["subtitle"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT
                )),
                Paragraph(f"<b>{date}</b><br/>{educator}", ParagraphStyle(
                    'Info',
    ...
    def _build_learning_objectives(self) -> Table:
        ...
        objective_data = [
            [
                Paragraph("<b>🎯 OBJECTIFS D'APPRENTISSAGE</b>", ParagraphStyle(
                    'SectionTitle',
        ...
        for i, objective in enumerate(objectives):
            objective_data.append([
                Paragraph(f"☐ {objective}", ParagraphStyle(
                    'Objective',
    ...
    def _build_key_concepts(self) -> List[Flowable]:
        ...
        # Section header
        content.append(
            Paragraph("<b>🧠 CONCEPTS CLÉS</b>", ParagraphStyle(
                'SectionHeader',
                fontSize=self.fonts["heading"][1],
                textColor=self.colors["primary"],
                alignment=TA_LEFT,
        ...
        for i, concept in enumerate(concepts):
            ...
            card_data = [
                [
                    Paragraph(f"<b>{i+1}. {concept_name}</b>", ParagraphStyle(
                        'ConceptTitle',
                        fontSize=self.fonts["subtitle"][1],
            ...
            if examples:
                ...
                card_data.append([
                    Paragraph(f"<b>Exemples:</b> {examples_text}", ParagraphStyle(
                        'Examples',
                        fontSize=self.fonts["caption"][1],
    ...
    def _build_comparison_section(self) -> Table:
            ...
            comparisons = [
                {
                    ...
                    "items": [
                        {"name": "Viande rouge", "value": 25, "unit": "g/100g", "note": "Riche en fer"},
                        {"name": "Poisson", "value": 22, "unit": "g/100g", "note": "Oméga-3"},
                        {"name": "Légumineuses", "value": 8, "unit": "g/100g", "note": "Fibres"}
                    ]
                }
            ]
        ...
        comparison_data = [
            [
                Paragraph("<b>📊 COMPARAISONS NUTRITIONNELLES</b>", ParagraphStyle(
                    'ComparisonTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
        ...
        for comparison in comparisons:
            ...
            for item in items:
                ...
                bar_width = min(200, (value / max_value) * 200) if max_value > 0 else 0
    ...
    def _build_practical_section(self) -> Table:
        ...
        practical_data = [
            [
                Paragraph("<b>💡 CONSEILS PRATIQUES</b>", ParagraphStyle(
                    'PracticalTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
        ...
        for i, tip in enumerate(tips):
            ...
            practical_data.append([
                Paragraph(f"{tip_icon} {tip}", ParagraphStyle(
                    'Tip',
                    fontSize=self.fonts["body"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT,
    ...
    def _build_progress_checklist(self) -> Table:
        ...
        checklist_items = self.data.get("progress_checklist", [
        ...
        checklist_data = [
            [
                Paragraph("<b>✅ AUTO-ÉVALUATION DES PROGRÈS</b>", ParagraphStyle(
                    'ChecklistTitle',
                    fontSize=self.fonts["heading"][1],
                    textColor=colors.white,
                    alignment=TA_CENTER
    ...
    def _build_resources_section(self) -> Table:
        ...
        resources = self.data.get("additional_resources", [
        ...
        resources_data = [
            [
                Paragraph("<b>📚 RESSOURCES COMPLÉMENTAIRES</b>", ParagraphStyle(
                    'ResourcesTitle',
                    fontSize=self.fonts["subtitle"][1],
                    textColor=self.colors["primary"],
                    alignment=TA_LEFT,
                ...
                Paragraph("<b>🎯 PROCHAINES ÉTAPES</b>", ParagraphStyle(
                    'NextStepsTitle',
                    fontSize=self.fonts["subtitle"][1],
                    textColor=self.colors["primary"],
                    alignment=TA_LEFT,
        ...
        for i in range(max_rows):
            ...
            resources_data.append([
                Paragraph(f"• {resource}" if resource else "", ParagraphStyle(
                    'Resource',
                    fontSize=self.fonts["caption"][1],
                    textColor=self.colors["text"],
                    alignment=TA_LEFT,
                ...
                Paragraph(f"→ {next_step}" if next_step else "", ParagraphStyle(
                    'NextStep',
                    fontSize=self.fonts["caption"][1],
                    textColor=self.colors["secondary"],
                    alignment=TA_LEFT,
