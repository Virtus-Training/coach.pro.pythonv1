...
class NutritionSheetScientificTemplate(BaseTemplate):
    ...
    def _get_default_scientific_content(self, field: str) -> Any:
        ...
        defaults = {
            ...
            "authors": [
                {
                    "name": "Dr. Jean Nutrition",
                    "affiliation": "Centre de Recherche Nutritionnelle",
                    "email": "j.nutrition@research.fr",
                },
                {
                    "name": "Prof. Marie Science",
                    "affiliation": "Université de Nutrition",
                    "email": "m.science@uni.fr",
                },
            ],
    ...
    def _build_title_page(self) -> Table:
        ...
        title_data = [
            ...
            [
                Paragraph(
                    "<b>RAPPORT SCIENTIFIQUE - NUTRITION CLINIQUE</b>",
                    ParagraphStyle(
                        "ReportType",
    ...
    def _build_methodology(self) -> Table:
        ...
        method_data.append(
            [
                Paragraph(
                    f"<b>Design de l'étude:</b> {study_design}",
                    ParagraphStyle(
                        "MethodItem",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
        ...
        method_data.append(
            [
                Paragraph(
                    f"<b>Intervention:</b> {intervention}",
                    ParagraphStyle(
                        "MethodItem",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
        ...
        if measurements:
            ...
            method_data.append(
                [
                    Paragraph(
                        f"<b>Mesures:</b> {measurements_text}",
                        ParagraphStyle(
                            "MethodItem",
                            fontSize=self.fonts["body"][1],
                            textColor=self.colors["text"],
        ...
        method_data.append(
            [
                Paragraph(
                    f"<b>Analyse statistique:</b> {stats}",
                    ParagraphStyle(
                        "MethodItem",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
    ...
    def _build_statistical_analysis(self) -> Table:
        ...
        stats_data = [
            [
                Paragraph(
                    "<b>ANALYSE STATISTIQUE - PARAMÈTRES</b>",
                    ParagraphStyle(
                        "StatsTitle",
                        fontSize=self.fonts["heading"][1],
                        textColor=colors.white,
    ...
    def _build_evidence_grading(self) -> Table:
        ...
        evidence_data = [
            [
                Paragraph(
                    "<b>CLASSIFICATION DE L'ÉVIDENCE</b>",
                    ParagraphStyle(
                        "EvidenceTitle",
                        fontSize=self.fonts["heading"][1],
                        textColor=colors.white,
            ...
            [
                ...
                Paragraph(
                    "Évidence forte - Recommandation basée sur des études randomisées de haute qualité",
                    ParagraphStyle(
                        "GradeDesc",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
            ...
            [
                ...
                Paragraph(
                    "Évidence modérée - Recommandation basée sur des études de qualité acceptable",
                    ParagraphStyle(
                        "GradeDesc",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
            ...
            [
                ...
                Paragraph(
                    "Évidence faible - Recommandation basée sur l'opinion d'experts ou études limitées",
                    ParagraphStyle(
                        "GradeDesc",
                        fontSize=self.fonts["body"][1],
                        textColor=self.colors["text"],
    ...
    def _build_limitations(self) -> Table:
        ...
        limitations_data = [
            [
                Paragraph(
                    "<b>LIMITATIONS ET CONSIDÉRATIONS</b>",
                    ParagraphStyle(
                        "LimitationsTitle",
                        fontSize=self.fonts["heading"][1],
                        textColor=colors.white,
