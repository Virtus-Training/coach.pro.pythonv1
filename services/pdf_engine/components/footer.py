...
class FooterComponent:
    ...
    def _build_footer_table(
        self, data: Dict[str, Any], template_config: Dict[str, Any]
    ) -> Any:
        """Build main footer table"""
        # Get configuration
        template_config.get("colors", {})
        template_config.get("fonts", {})
    ...
    def _get_left_element(
        ...
        return Paragraph(
            brand_style, self._get_paragraph_style("left", template_config)
        )

    def _get_center_element(
        self, data: Dict[str, Any], template_config: Dict[str, Any]
    ) -> Any:
        ...
        return Paragraph(
            text_style, self._get_paragraph_style("center", template_config)
        )

    def _get_right_element(
        self, data: Dict[str, Any], template_config: Dict[str, Any]
    ) -> Any:
        ...
        return Paragraph(
            date_style, self._get_paragraph_style("right", template_config)
        )
