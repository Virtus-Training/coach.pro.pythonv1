...
class MealPlanGeneratorService:
    ...
    def generer_plan_simple(
        self, client_id: int, objectif_kcal: float = 2000, nom_plan: str = "Plan généré"
    ) -> Dict[str, Any]:
    ...
    def obtenir_suggestions_aliments(
        self, objectif: str = "maintenance", limit: int = 10
    ) -> List[Aliment]:
